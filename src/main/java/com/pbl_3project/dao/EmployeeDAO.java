...
public class EmployeeDAO {
    ...
    // 1. Hàm lấy danh sách và Tìm kiếm nhân viên (Chỉ lấy Role 2 và 3)
    public DefaultTableModel searchEmployees(String keyword) throws SQLException {
        ...
        DefaultTableModel model = new DefaultTableModel(columnNames, 0) {
            ...
            public boolean isCellEditable(int row, int column) {
                return false;
            } // Khóa không cho sửa trực tiếp trên bảng
        };
    ...
    // 2. Hàm thêm Nhân viên mới (ID tự động tăng trong SQL)
    public boolean addEmployee(String fullName, String email, String phone, int roleId, String password)
        ...
        try {
            conn = DatabaseConnection.getConnection();
            // Cột ID không cần truyền vào vì SQL dùng IDENTITY(1,1) tự động tăng
            ...
            pstmt.setString(5, password); // Thực tế nên mã hóa MD5/SHA256 ở đây
