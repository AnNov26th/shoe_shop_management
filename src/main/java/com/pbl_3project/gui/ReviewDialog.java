...
public class ReviewDialog extends JDialog {
    ...
    private void loadProducts() {
        try {
            ...
            for (int i = 0; i < model.getRowCount(); i++) {
                ...
                // Need product_id from SKU? Or change OrderDetail to return product_id
                // For now, let's assume we can get it or just use SKU for identification
    ...
    private void handleSubmit() {
        try {
            ...
            // For simplicity, we need productId. Let's assume we fetch it or pass it.
            // If the system uses SKU, we can find productId from SKU.
            for (ProductReviewPanel p : productReviewPanels) {
                // Find productId from SKU
    ...
    private int findProductIdBySku(String sku) {
        // Simple mock or call DB. Better to call DB.
