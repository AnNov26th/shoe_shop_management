...
public class AddProductDialog extends JDialog {
    ...
    public AddProductDialog(JFrame parent, Runnable onSuccess) {
        ...
        JComboBox<String> cbxCategory = createComboBox(CATEGORIES);
        JComboBox<String> cbxBrand = createComboBox(BRANDS);

        JPanel imagePanel = new JPanel(new BorderLayout(10, 0));
        imagePanel.setBackground(Color.WHITE);
        JButton btnChooseImage = new JButton("Chọn Ảnh");
        btnChooseImage.setFont(new Font("Segoe UI", Font.PLAIN, 14));
        ...
        JComboBox<String> cbxGender = createComboBox(new String[] { "Nam", "Nữ", "Unisex" });
        JTextField txtPrice = createTextField();

        JSpinner spnQuantity = new JSpinner(new SpinnerNumberModel(0, 0, 10000, 1));
        ...
        JButton btnSave = createStyledButton("LƯU", new Color(16, 185, 129), Color.WHITE);
