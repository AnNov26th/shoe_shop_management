...
public class EmployeeManagementPanel extends JPanel {
    ...
    // Label động để chứa tên người mới nhất
    ...
    private void initComponents() {
        // ==========================================
        // 1. TOP SECTION (FORM & THÔNG TIN NHANH)
        // ==========================================
        JPanel topPanel = new JPanel(new BorderLayout(25, 0));
        topPanel.setOpaque(false);

        // --- 1.1 FORM THÊM NHÂN VIÊN (BÊN TRÁI) ---
        ...
        // Thẻ động: Khởi tạo rỗng, sẽ được điền số liệu ở hàm loadTableData
        ...
        btnSave.addActionListener(e -> {
            ...
            int roleId = cbRole.getSelectedIndex() + 1; // 0=Admin(1), 1=Manager(2), 2=Staff(3)
            ...
            switch (result) {
                ...
                case "SUCCESS":
                    ...
                    clearForm();
                    loadTableData(""); // Load lại thì hàm này sẽ tự update luôn người mới nhất
                    break;
                default:
    ...
    // Dùng cho Label động (Cập nhật được nội dung)
    private JPanel createStatCard(String title, JLabel lblValue) {
        ...
        p.setMaximumSize(new Dimension(280, 70)); // Khống chế chiều cao
    ...
    private void loadTableData(String keyword) {
        try {
            ...
            // --- LOGIC TÌM NHÂN VIÊN MỚI NHẤT ---
            // Chỉ cập nhật khi không tìm kiếm (tải toàn bộ danh sách)
            if ((keyword == null || keyword.trim().isEmpty()) && model.getRowCount() > 0) {
                int maxId = -1;
                String newestName = "Chưa có";

                // Lặp qua bảng để tìm dòng có ID to nhất
    ...
    // ==========================================
    // CLASS CUSTOM PANEL BO GÓC MƯỢT MÀ
    // ==========================================
