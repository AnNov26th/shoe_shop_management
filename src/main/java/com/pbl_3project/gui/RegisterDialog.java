...
public class RegisterDialog extends JDialog {
    ...
    public RegisterDialog(Frame parent) {
        ...
        btnCancel = createStyledButton("Hủy", new Color(243, 244, 246), new Color(55, 65, 81),
    ...
    private void handleRegister() {
        ...
        if (name.isEmpty() || email.isEmpty() || pass.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Vui lòng điền các trường bắt buộc (*)", "Lỗi",
        ...
        try {
            ...
            if (userDAO.addUser(name, email, pass, phone, 4)) {
                JOptionPane.showMessageDialog(this, "Đăng ký thành công! Bạn có thể đăng nhập ngay.", "Thành công",
                        JOptionPane.INFORMATION_MESSAGE);
                dispose();
            } else {
                JOptionPane.showMessageDialog(this, "Đăng ký thất bại. Vui lòng thử lại.", "Lỗi",
                        JOptionPane.ERROR_MESSAGE);
            }
