...
public class ProductDetailDialog extends JDialog {
    ...
    public ProductDetailDialog(JFrame parent, int productId, String productName, double basePrice,
        ...
        setSize(1000, 700); // Kích thước mặc định lớn
        setMinimumSize(new Dimension(800, 600));
        setResizable(true); // Cho phép kéo giãn và mở rộng full màn hình
    ...
    private void initComponents() {
        ...
        // ==========================================
        // 1. PHẦN BÊN TRÁI: HÌNH ẢNH (IMAGE SECTION)
        // ==========================================
        ...
        // ==========================================
        // 2. PHẦN BÊN PHẢI: THÔNG TIN & BẢNG (INFO SECTION)
        // ==========================================
        ...
        lblPrice.setForeground(new Color(239, 68, 68)); // Màu đỏ nổi bật
        ...
        // --- SỰ KIỆN: Click dòng nào đổi ảnh đó ---
