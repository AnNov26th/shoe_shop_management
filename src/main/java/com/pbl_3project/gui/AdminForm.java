...
public class AdminForm extends JFrame {
    ...
    public AdminForm() {
        setTitle("Hệ thống Quản lý Cửa hàng Giày dép - [QUYỀN ADMIN]");
        setSize(1200, 750);
    ...
    private void initComponents() {
        ...
        lblAdmin.setFont(new Font("Cambria", Font.BOLD, 22));
        ...
        menuPanel.add(btnThongKe);      menuPanel.add(Box.createVerticalStrut(5));
        menuPanel.add(btnSanPham);      menuPanel.add(Box.createVerticalStrut(5));
        menuPanel.add(btnKhoHang);      menuPanel.add(Box.createVerticalStrut(5));
        menuPanel.add(btnDonHang);      menuPanel.add(Box.createVerticalStrut(5));
        menuPanel.add(btnKhuyenMai);    menuPanel.add(Box.createVerticalStrut(5));
        menuPanel.add(btnNhanVien);     menuPanel.add(Box.createVerticalStrut(5));
        ...
        btnThongKe.addActionListener(e -> { selectMenuButton(btnThongKe); cardLayout.show(mainContentPanel, "ThongKe"); });
        btnSanPham.addActionListener(e -> { selectMenuButton(btnSanPham); cardLayout.show(mainContentPanel, "SanPham"); });
        btnKhoHang.addActionListener(e -> { selectMenuButton(btnKhoHang); cardLayout.show(mainContentPanel, "KhoHang"); });
        btnDonHang.addActionListener(e -> { selectMenuButton(btnDonHang); cardLayout.show(mainContentPanel, "DonHang"); });
        btnKhuyenMai.addActionListener(e -> { selectMenuButton(btnKhuyenMai); cardLayout.show(mainContentPanel, "KhuyenMai"); });
        btnNhanVien.addActionListener(e -> { selectMenuButton(btnNhanVien); cardLayout.show(mainContentPanel, "NhanVien"); });
        btnKhachHang.addActionListener(e -> { selectMenuButton(btnKhachHang); cardLayout.show(mainContentPanel, "KhachHang"); });
